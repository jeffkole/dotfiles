...
cdh3_hive_home=$hadoop_root/hive-0.7.1-cdh3u4
cdh4_hive_home=$hadoop_root/hive-0.9.0-cdh4.1.1
...
function __add_hadoop_to_path() {
    ...
    export PATH=$path:$HADOOP_HOME/bin:$HBASE_HOME/bin:$HIVE_HOME/bin:$WIBI_HOME/bin
}

function cdh3() {
    export HADOOP_HOME=$cdh3_hadoop_home
    export HBASE_HOME=$cdh3_hbase_home
    export HIVE_HOME=$cdh3_hive_home
...
function cdh4() {
    ...
    export HIVE_HOME=$cdh4_hive_home
